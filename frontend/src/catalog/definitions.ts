...
export const demonstrationCatalogDefinitions = {
  ...
  PieChart: {
    description: "A pie/donut chart. Provide data as array of {label, value, color}.",
    props: z.object({
      data: z.array(
        z.object({
          label: z.string(),
  ...
  BarChart: {
    description: "A bar chart. Provide data as array of {label, value}.",
    props: z.object({
  ...
  Button: {
    description: "An interactive button with optional action dispatch.",
    props: z.object({
